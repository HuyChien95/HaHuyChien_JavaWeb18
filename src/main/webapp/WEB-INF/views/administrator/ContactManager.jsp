			...
			<div class="layout-page">
				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						...
						<div class="card">
							<h5 class="card-header">Danh Sách Tin Nhắn</h5>
									...
									<tbody class="table-border-bottom-0">
										<c:forEach var="contact" items="${contact}">
											<tr>
												...
												<td>
													<a class="dropdown-item" href="${base}/admin/contact/${contact.id}"><i class="bx bx-show-alt me-2"></i> Xem Chi Tiết</a>
													<div class="dropdown-item" onclick="deleteBtn()"><i class="bx bx-trash me-2"></i>Xóa</div>
												</td>
											</tr>
										</c:forEach>
									</tbody>
